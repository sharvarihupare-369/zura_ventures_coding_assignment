...
const Home = () => {
  ...
  return (
    <div>
      ...
      {
        allProjects.length  ? <HomPage2/> : <div >
      ...
      <div className="flex justify-center">
        <button onClick={()=>setIsModalOpen(true)} className="flex justify-center bg-[#211935] mt-8 text-white   text-[20px] py-2  rounded-lg flex gap-3 items-center">
          <img className="bg-[#211935] w-[11%]" src={plusimage} alt="createbutton" />
          Create New Project
        </button>
      </div>
        </div>
